...
$query =  "SELECT * FROM  `artnew` WHERE nameru = '$art' ";
			...
			$nametab = "new".$edit['namelt'];
}

$query = "create table if not exists `".$nametab."`(id int(100)  primary key auto_increment, buy varchar(100), sell varchar(100), discru varchar(1000), disccn varchar(1000), price varchar(20))";
mysql_query($query);
$str = $edit['namelt'];
$dir = str_replace(' ', '', $str);
