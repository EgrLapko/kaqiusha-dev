...
setcookie ("linkcn", 苏联画家作品,time()+3600,"/","kaqiusha.net.cn");
setcookie ("linkru", 'Картины художников СССР',time()+3600,"/","kaqiusha.net.cn");
...
<meta content="苏联画家作品" name="keywords">
<meta content="苏联画家作品" name="description">
...
<div class="nav_all">
	...
	<p1>прикладное</p1>
		...
		<p class="cn_all" style="padding-top:100px">分类</p>
	<p1>жанры</p1>&nbsp;
  ...
  { 
  	$alp=($arr[$i]);
  	 $alp=trim($alp);
  			$query =  "SELECT `namelt`, `namecn`, `photoid` FROM `art` WHERE LEFT(`namelt`, 1) = '$alp'";
            ...
            if (!$prt['namelt']) {}
             ...
             $table = "<table class='table' cellspacing='25' ><tr>\n";
                        ...
                        $td=0;
                          ...
                          $img = "data/art/photoid/".$rowq['photoid'];
                          $td++;$all++;
             $table .= '<td style="vertical-align: bottom;"><a target="_blank" href="cardartist.php?artbio='.$rowq['namelt'].'">';
             $table .="<img style='max-width: 145px;  max-height: 175px' src = '".$img."' /></a><br><img style='padding:15px 20px 8px 20px;box-shadow:none; ' height='1' src='img/lineblack.png' width='120' /><p style='color:white; font-size:18px;  margin-bottom: 0;  margin-top: 5px;' ><a target='_blank' href='cardartist.php?artbio=".$rowq['namelt']." '><strong>".$rowq['namecn']."</strong></a><br>";
