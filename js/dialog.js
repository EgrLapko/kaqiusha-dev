...
Скрипт предоставлен администрацией сайта http://mastersloga.ru .
...
e.target="_blank";
e.href="http://mastersloga.ru";
e.innerHTML="Copywriting";
b.appendChild(e);
...
s.display="block";
var w=d.w.toString().indexOf("%")>0?Math.round(parseInt(d.w)*b.parentNode.offsetWidth/300):d.w;
var h=d.h.toString().indexOf("%")>0?Math.round(parseInt(d.h)*b.parentNode.offsetHeight/300):d.h;
